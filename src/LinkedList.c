...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if(this != NULL)
    {
		...
		if(largo >= 0)
		{
			if(nodeIndex > -1 && nodeIndex <= largo)
			{
				nuevoNodo = (Node*) malloc (sizeof(Node));
				if(nuevoNodo != NULL)
				{
					if(largo == 0 || nodeIndex == 0)
					{
...
int ll_push(LinkedList* this, int index, void* pElement)
{
    ...
    if(this != NULL && index >= 0 && index <= largo)
    {
    	...
    	nodoSumar = (Node*) malloc (sizeof(Node));
    	...
    	if(nodoSumar != NULL)
    	{
			...
			else
			{
				...
				{
					nodoAnterior->pNextNode = nodoSumar;
				}
			}

			nodoSumar->pNextNode = nodoPosterior;
			nodoSumar->pElement = pElement;
			this->size++;
			retorno = 0;
    	}
    }
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    if(this != NULL && from >= 0 && from < to && to <= largo)
    {
    	Node* nodoAux;
...
/**
 * @brief * Completa un campo del elemento, recibiendo como par�metro
...
/**
 * @brief * Filtra la lista con una condici�n, recibiendo como par�metro
